...
class PaymentController extends Controller
{
                ...
                switch ($paymentMode) {
                  ...
                  case 'CARD':
                    ...
                    return $gateway->process([
                        ...
                        'card'          => $Card->card_id,
                        'description'   => 'Travel payment ' . Auth::user()->email,
    ...
    public function send_money(Request $request, $id)
    {
        try {
            ...
            $tranfer = \Stripe\Transfer::create([
                'amount'      => $StripeCharge,
                'currency'    => 'brl',
        ...
        switch ($log->payment_mode) {
          ...
          case 'CARD':
            ...
            if (!is_null($log->transaction_id)) {
                ...
                (new SendPushNotification())->sendPushToProvider($RequestPayment->provider_id, 'You received R$' . $RequestPayment->provider_pay . ' in your wallet!');
                (new SendPushNotification())->sendPushToUser($RequestPayment->user_id, 'We charge the R value of your card$' . $RequestPayment->payable . '!');
            }
            break;
          case 'PAYUMONEY':
            // code...
