...
class GeoFencingResource extends Controller
{
    ...
    public function __construct()
    {
        ...
        //$this->middleware('permission:geo-list', ['only' => ['index']]);
        //$this->middleware('permission:geo-create', ['only' => ['create', 'store']]);
        //$this->middleware('permission:geo-edit', ['only' => ['edit', 'update']]);
    }
    ...
    public function index()
    {
        ...
        //DB::select("ALTER TABLE `states` CHANGE `id` `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT;");
