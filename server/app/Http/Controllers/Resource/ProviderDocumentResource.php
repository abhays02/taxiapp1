        ...
        try {
            ...
            if($request->method == "update"){
                ...
                if($ProviderFleet){
                    ...
                    return redirect()->route('admin.provider.document.index', $provider)->with('flash_error', "The service does not belong to the driver's registration city. Please select a service from the same franchise as the driver.");
                }
            }
