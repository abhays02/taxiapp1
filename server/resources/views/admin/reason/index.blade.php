...
@section('title', 'Reasons for Cancellation ')
@section('style')
...
<div class="page-header">
        ...
        <div class="page-header-actions">
                        <button type="button" class="btn btn-sm btn-icon btn-default btn-outline btn-round waves-effect waves-classic" data-toggle="tooltip" data-original-title="@lang('admin.reason.add_reason')">
                <a href="{{ route('admin.reason.create') }}"> <i class="icon wb-plus" aria-hidden="true"></i> @lang('admin.reason.add_reason')</a>
            </button>
        </div>
        @endcan
</div>
    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                ...
                @endif
                <h5 class="example-title">@lang('admin.reason.title')</h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('admin.reason.destroy', $reason->id) }}" method="POST">
                                    ...
                                    <a href="{{ route('admin.reason.edit', $reason->id) }}" class="btn btn-info waves-effect waves-classic waves-effect waves-classic"><i class="icon md-edit" aria-hidden="true"></i></a>
                                    @endcan
