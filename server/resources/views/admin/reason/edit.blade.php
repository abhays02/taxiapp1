...
@section('title', 'Update Reason for Cancellation ')
...
<div class="page-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">@lang('admin.reason.update_reason')</li>
        </ol>
...
<div class="content-area py-1">
    <div class="container-fluid">
    	<h5 class="example-title">@lang('admin.reason.update_reason')</h5>
