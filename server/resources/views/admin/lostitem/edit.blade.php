...
@section('title', 'Update Lost Item')
...
<div class="page-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">@lang('admin.lostitem.update')</li>
        </ol>
...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            <h5 class="example-title">@lang('admin.lostitem.update')</h5>
            ...
            <form class="form-horizontal" action="{{route('admin.lostitem.update', $lostitem->id)}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    <label for="comments" class="col-md-3 col-form-label">@lang('admin.lostitem.lost_comments')</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    <label for="status" class="col-md-3 col-form-label">@lang('admin.lostitem.lost_status')</label>
                    <div class="col-md-6">
