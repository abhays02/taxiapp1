...
<div class="page-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">@lang('admin.push.Push_Notification')</li>
        </ol>
</div>
...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            @endif 
            <h5 class="example-title">@lang('admin.push.Push_Notification')</h5>
            ...
            <form class="form-horizontal" action="{{route('admin.send.push')}}" method="POST" role="form" id="create_push">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label">@lang('admin.push.Sent_to')</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row" id="for_users" style="display: none;">
                    <label class="col-md-3 col-form-label">User Conditions</label>
                    <div class="col-md-6">
                        <select class="form-control" name="user_condition" onchange="switch_user_condition(this.value);">
                            <option value="">None</option>
                            <option value="ACTIVE">For active users in </option>
                    ...
                    <div class="col-md-6" id="user_active" style="display: none;">
                    ...
                    <div class="col-md-6" id="user_rides"  style="display: none;">
                        <input type="number" class="form-control" name="user_rides" placeholder="Number of Trips">
                    </div>

                    <div class="col-md-6" id="user_amount" style="display: none;">
                        <input type="number" class="form-control" name="user_amount" placeholder="Amount Spent">
                    </div>

                    <div class="col-md-6" id="user_location" style="display: none;">
                ...
                <div class="form-group row" id="for_providers" style="display: none;">
                    <label class="col-md-3 col-form-label">Condition of Drivers</label>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6" id="provider_active" style="display: none;">
                    ...
                    <div class="col-md-6" id="provider_rides"  style="display: none;">
                        <input type="number" class="form-control" name="provider_rides" placeholder="Number of Trips">
                    </div>

                    <div class="col-md-6" id="provider_amount" style="display: none;">
                        <input type="number" class="form-control" name="provider_amount" placeholder="Amount Spent">
                    </div>

                    <div class="col-md-6" id="provider_location" style="display: none;">
                ...
                <div class="form-group row">
                    <label for="message" class="col-md-3 col-form-label">@lang('admin.push.message')</label>
                    <div class="col-md-6">
        ...
        <div class="box box-block bg-white">
            <h5 class="example-title">@lang('admin.push.Notification_History')</h5>
        ...
        <div class="modal-content">
            ...
            <form>
                <div class="modal-body">
                    ...
                    <label>Hora</label>
                    <input value="{{date('H:i')}}" class="form-control" type="text" id="timepicker" placeholder="Hour" name="schedule_time">
