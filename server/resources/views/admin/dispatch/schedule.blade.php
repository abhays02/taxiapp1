...
<div class="page-header">
        ...
        <div class="page-header-actions">
          <button type="button" class="btn btn-sm btn-icon btn-default btn-outline btn-round" data-toggle="tooltip" data-original-title="Add">
            <i class="icon wb-add" aria-hidden="true"></i>
          </button>
        </div>
</div>
...
<div class="content-area py-1">
    <div class="container-fluid">
        <h4 class="example-title">Dispatcher</h4>
