...
<div class="page-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">@lang('admin.heatmap.godseye')</li>
        </ol>
        ...
        <div class="box box-block bg-white">
            <div class="clearfix mb-1">
                ...
                <div class="float-xs-right">
                    ...
                    <button class="btn btn-default godseye_menu" data-value="ARRIVED">On Boarding Place</button>
                    <button class="btn btn-default godseye_menu" data-value="PICKEDUP">Traveling</button>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
