...
<div class="page-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">@lang('admin.account-manager.add_account_manager')</li>
        </ol>
...
<div class="content-area py-1">
    <div class="container-fluid">
            <h5 class="example-title">@lang('admin.account-manager.add_account_manager')</h5>
