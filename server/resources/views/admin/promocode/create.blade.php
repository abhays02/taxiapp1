...
@section('title', 'Add Promotional Coupon ')
...
<div class="page">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('admin.promocode.add_promocode')</li>
        </ol>
            ...
            <div class="panel-body container-fluid">
                <div class="content-area py-1">
                    <div class="container-fluid">
                        ...
                        <h5 class="example-title">@lang('admin.promocode.add_promocode')</h5>

                        <p style="color: #cc0033; text-align:center;"><b>Note:</b> Each user can use this coupon once
                        ...
                        <form class="form-horizontal" action="{{route('admin.promocode.store')}}" method="POST"
                            ...
                            <div class="row  mb-4 p-4">
                                ...
                                <div class="form-group col-md-6 mb-6">
                                    ...
                                    <div class="">
                                        <input class="form-control" type="number" value="{{ old('percentage') }}"
                                ...
                                <div class="form-group col-md-4 mb-4">
                                    ...
                                    <div class="">
                                        <input class="form-control datetimepicker" id="datetimepicker" type="text"
                                            value="{{old('expiration')}}" name="expiration" required id="expiration"
                                ...
                                <div class="form-group col-md-4 mb-4">
                                    ...
                                    <div class="">
                                        <textarea id="promo_description" placeholder="Description" class="form-control"
                                            name="promo_description">0% off, Maximum discount of 0 {{old ('promo_description')}}</textarea>
                                    </div>
                                </div>

                                <div class="form-footer aproveReject col-12 text-right">
                                    <button type="submit"
                                        class="btn btn-primary">@lang('admin.promocode.add_promocode')</button>
