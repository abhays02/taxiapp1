...
<div class="page-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">@lang('admin.review.User_Reviews')</li>
        </ol>
    ...
    <div class="content-area py-1">
        <div class="container-fluid">
            ...
            <div class="box box-block bg-white">
                <h5 class="example-title">@lang('admin.review.User_Reviews')</h5>
                <table class="table table-striped" id="exampleTableTools">
                    <thead>
                        <tr>
                            ...
                            <th>User @lang('admin.review.Rating')</th>
                            <th>Provider @lang('admin.review.Rating')</th>
                            <th>@lang('admin.request.Date_Time')</th>
                            <th>User @lang('admin.review.Comments')</th>
                            <th>Driver @lang('admin.review.Comments')</th>
