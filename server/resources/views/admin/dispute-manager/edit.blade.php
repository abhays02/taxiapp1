...
<div class="page-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">@lang('admin.dispute-manager.update_dispute_manager')</li>
        </ol>
...
<div class="content-area py-1">
    <div class="container-fluid">
            ...
            <h5 class="example-title">@lang('admin.dispute-manager.update_dispute_manager')</h5>
