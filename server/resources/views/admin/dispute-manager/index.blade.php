...
<div class="page-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">@lang('admin.dispute-manager.dispute_manager')
        ...
        <div class="page-header-actions">
                  <button type="button" class="btn btn-sm btn-icon btn-default btn-outline btn-round" data-toggle="tooltip" data-original-title="@lang('admin.dispute-manager.add_new_dispute_manager')">
            <a href="{{ route('admin.dispute-manager.create') }}"> <i class="icon wb-plus" aria-hidden="true"></i> @lang('admin.dispute-manager.add_new_dispute_manager')</a>
          </button>
        </div>
        @endif
</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('admin.dispute-manager.destroy', $account->id) }}" method="POST">
                                ...
                                <a href="{{ route('admin.dispute-manager.edit', $account->id) }}" class="btn btn-icon social-twitter waves-effect waves-classic"><i class="icon md-edit"></i></a>
