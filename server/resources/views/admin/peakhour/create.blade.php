...
@section('title', 'Add Peak Schedule')
...
<div class="page">
  <div class="page-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">@lang('admin.peakhour.add_time')</li>
    </ol>
      ...
      <div class="panel-body container-fluid">
        <div class="content-area py-1">
          <div class="container-fluid">
            ...
            <h5 class="example-title">@lang('admin.peakhour.add_time')</h5>

            <form class="form-horizontal" action="{{route('admin.peakhour.store')}}" method="POST"
              ...
              <div class="row  mb-4 p-4">
                ...
                <div class="form-group col-md-4 mb-4">
                  ...
                  <div class="">
                    <input class="form-control" autocomplete="off" type="text" value="{{ old('start_time') }}"
                      name="start_time" id="start_time" placeholder="@lang('admin.peakhour.start_time')">
                  </div>
                </div>
                ...
                <div class="form-group col-md-4 mb-4">
                  ...
                  <div class="">
                    <input class="form-control" autocomplete="off" type="text" value="{{ old('end_time') }}"
                      name="end_time" id="end_time" placeholder="@lang('admin.peakhour.end_time')">
                  </div>
                </div>
