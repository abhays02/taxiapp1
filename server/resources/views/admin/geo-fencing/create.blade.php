...
<div class="page">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('admin.geo_fencing.Add_Geo_Fencing')</li>
        </ol>
        ...
        <div class="content-area py-1">
            <div class="container-fluid">
                <div class="box box-block bg-white">
                    ...
                    <form class="form-horizontal" action="{{route('admin.geo-fencing.store')}}" method="POST"
                        enctype="multipart/form-data" role="form">
                        {{ csrf_field() }}
                        <div class="form-group col-md-12 mb-4">
                            <label for="name"
                                class="col-md-2 col-form-label">@lang('admin.geo_fencing.City_Name')</label>
                            <div class="col-md-6">
                                <input class="form-control" type="text" value="{{ old('city_name') }}" name="city_name"
                            ...
                            <div class="col-xs-10">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 offset-md-6 col-md-3">
                                        <button type="submit"
                                            class="btn btn-primary btn-block">@lang('admin.geo_fencing.Add_Geo_Fencing')</button>
                                    </div>
                                </div>
                            </div>
                        </div>
