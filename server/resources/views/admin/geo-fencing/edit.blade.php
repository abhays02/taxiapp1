...
@section('title', 'Update Geo Fencing ')
...
<div class="page">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">@lang('admin.geo_fencing.Update_Geo_Fencing')</li>
        </ol>
        ...
        <div class="content-area py-1">
            <div class="container-fluid">
                <div class="box box-block bg-white">
                    <form class="form-horizontal" action="{{route('admin.geo-fencing.update', $show->id )}}"
                        method="POST" enctype="multipart/form-data" role="form">
                        {{csrf_field()}}
                        <input type="hidden" name="_method" value="PATCH">
                        <div class="form-group col-md-12 mb-4">
                            <label for="name"
                                class="col-xs-2 col-form-label">@lang('admin.geo_fencing.City_Name')</label>
                            <div class="col-xs-10">
                                <input class="form-control" type="text" value="{{ $show->city_name }}" name="city_name"
                                    required id="city_name" placeholder="City Name">
                            </div>
                        </div>

                        <div class="form-group col-md-12 mb-4">
                            <label for="provider_name"
                                class="col-xs-2 col-form-label">@lang('admin.geo_fencing.Ranges')</label>
                            <div class="col-xs-10">
                                ...
                                <input type="hidden" name="ranges" class="ranges" value="{{ $show->ranges }}">
                            </div>
                        </div>
                        <div class="form-group col-md-12 mb-4">
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <a href="{{route('admin.geo-fencing.index')}}"
                                    class="btn btn-danger btn-block">@lang('admin.cancel')</a>
                            </div>
                            <div class="col-xs-12 col-sm-6 offset-md-6 col-md-3">
                                <button type="submit"
                                    class="btn btn-primary btn-block">@lang('admin.geo_fencing.Update_Geo_Fencing')</button>
                            </div>
                        </div>
                    </form>
                </div>
...
@section('script')
<script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCwRYqZJh3Y9p45XSMOBUQVY4gbshfmRys&libraries=places,drawing&callback=initMap"
    async defer></script>
<script>
    var map;
    var polygon;
