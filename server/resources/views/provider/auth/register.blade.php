...
<!--            <div class="col-md-4">
            ...
            <div>
                <input type="phone" id="phone_number" class="form-control form_tel" placeholder="@lang('provider.signup.enter_phone')" name="phone_number" value="+91" data-stripe="number" maxlength="11" onkeypress="return isNumberKey(event);"/>
            </div>
