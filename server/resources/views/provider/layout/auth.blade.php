            ...
            <div class="full-page-bg-inner">
                <div class="row no-margin">
                    <div class="col-md-6 log-left">
                        ...
                        <h2>{{config('constants.site_title','Moob Urban')}} need partners like you.</h2>
                        <p>Drive with {{config('constants.site_title','Moob Urban')}} and earn a lot of money with an independent contractor. Get paid weekly just to help our community of pilots take tours around the city. Be your own boss and get paid for driving fees at your own time.</p>
                    </div>
