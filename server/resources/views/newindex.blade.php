...
<div class="banner row no-margin" style="background-position: center; background-image: url('{{ asset('asset/img/login-bg.jpg') }}');">
    ...
    <div class="container slider pad-60">
        ...
        <div class="col-md-12 center ">
            ...
            <h2 class="banner-head">Travel or delivery?<br>It's your choice</h2>
        </div>
    </div>
    <div class="row">
        <div class="col-md-3 col-md-offset-3">
             <div class="row no-margin fields banner-ride-drive">
                    ...
                    <div class="btn-txt">
                        <a href="{{url('login')}}">
                            <h3 class="btn-title">Passenger</h3>
                            <!-- <h5>SIGN UP <i class="fa fa-chevron-right"></i></h5> -->
                        </a>
                    </div>
                </div>
...
<div class="row white-section pad-60">
    <div class="container">
        ...
        <div class="col-md-6">
            ...
            <h2>Agility, practicality and safety in the palm of your hand</h2>
            <div class="title-divider"></div>
            <p>Moovim is the smartest way to get around. One touch and a car or motorcycle comes to you. Your driver knows exactly where to go. And you can pay with cash or card.</p>
            <a class="content-more more-btn" href="{{url('/ride')}}">KNOW MORE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
    </div>
</div>
...
<div class="row gray-section pad-60">
    <div class="container">                
        <div class="col-md-6">
            ...
            <div class="title-divider"></div>
            <p>Travel to work, deliveries, city tours, going to college, that night club, wherever you go, count on Moovim for a safe trip.</p>
            <a class="content-more more-btn" href="{{url('/ride')}}">KNOW MORE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
        <div class="col-md-6 img-box text-center"> 
...
<div class="row white-section pad-60">
    <div class="container">
        ...
        <div class="col-md-6 content-block">
            ...
            <h2>Low cost executive transport</h2>
            <div class="title-divider"></div>
            <p>Are you going by car or motorcycle? with Moovim, you get low-cost executive transportation.</p>
            <a class="content-more more-btn" href="{{url('/ride')}}">KNOW MORE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
</div>
...
<div class="row gray-section pad-60 full-section">
    <div class="container">                
        <div class="col-md-6 content-block">
            ...
            <h5>Behind the voter</h5>
            <h2>Are people like you, following your path</h2>
            <div class="title-divider"></div>
            <p>Moovim has the most responsible drivers, they are people with great experience and passionate about what they do. They are mothers and fathers, students and teachers, veteran neighbors, friends, our day-to-day partners.</p>
            <a class="content-more more-btn" href="{{ url('/drive') }}">I WANT TO BE A DRIVER <i class="fa fa-chevron-right"></i></a>
        </div>
...
<div class="row white-section pad-60 ">
    <div class="container">
        ...
        <div class="col-md-6 content-block">
            ...
            <h2>Contributing to transport for the good of all</h2>
            <div class="title-divider"></div>
            <p>A city with Moovim has more economic opportunities for residents and better access to transportation for those who do not have it.</p>
            <a class="content-more more-btn" href="{{ url('/login') }}">REQUEST YOUR SHIPPING <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
</div>
...
<div class="row gray-section pad-60 full-section">
    <div class="container">
        <div class="col-md-6 content-block">
            ...
            <h2>Safety with people first</h2>
            <div class="title-divider"></div>
            <p>Whether riding in the back seat or driving in the front, the entire {{config ('constants.site_title', 'Moob Urban')}} system has been developed to give you the best travel experience with total quality and safety.</p>
