...
<!--                            <div id="first_step">
                            ...
                            <div id="second_step">
                                ...
                                <div class="col-md-6">
                                    <input type="text" autofocus class="form-control" placeholder="Name" name="first_name" value="{{ old('first_name') }}" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="First Name can only contain alphanumeric characters and . - spaces">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="Surname" name="last_name" value="{{ old('last_name') }}" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="Last Name can only contain alphanumeric characters and . - spaces">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="phone_number" class="form_tel" class="form-control" placeholder="Cell phone number with area code" name="phone_number" value="{{ old('phone_number') }}" data-stripe="number" maxlength="15" onkeypress="return isNumberKey(event);" required/>
                                </div>

                                <div class="col-md-12">
                                    <label class="checkbox"><input type="radio" name="gender" value="MALE" data-validation="required"  data-validation-error-msg="Por favor, selecione um gênero"> Male</label>
                                    <label class="checkbox"><input type="radio" name="gender" value="FEMALE" data-validation-error-msg="Por favor, selecione um gênero"> Female</label>
                                ...
                                <div class="col-md-12">
                                    <input type="password" placeholder="Repeat the password" class="form-control" name="password_confirmation" data-validation="confirmation" data-validation-confirm="password" data-validation-error-msg="As senhas não correspondem">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="Reference Code (Optional)" class="form-control" name="referral_code" >
                                ...
                                <div class="col-md-12">
                                    <button class="log-teal-btn" type="submit">SIGN UP</button>
                                </div>
                        ...
                        <div class="col-md-12">
                            <p class="helper">Or <a href="{{route('login')}}">In between</a> with your user account.</p>   
                        </div>
