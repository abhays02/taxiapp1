                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a class="btn-outline" href="{{url('/register')}}">Passenger Registration</a></li>
                                    <li><a class="menu-btn" href="{{url('/provider/register')}}">Driver Registration</a></li>
                                </ul>
                            </div>
                        </div>
                    </nav>
                ...
                <div class="container-fluid call-us gray-section content-block pad-60">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12  col-md-6 sup-txt"><h2>Need help? Contact us</h2>
                                <div class="call-num">
                    ...
                    <div class="footer row no-margin">
                        <div class="container-fluid">
                            <div class="row app-dwon pad-60">
                                <div class="container pad-60">
                                    <div class="row center">
                                        <h2>Get the app</h2>
                                        <p class="white">Get the passenger and driver apps for Android and iOS for free</p><br>
                                        <div class="">
                            ...
                            <div class="foot-block col-md-3 col-sm-12 col-xs-12">
                                <a href="{{url('help')}}" class="foot-item"> <h5 class="foot-tit">Help</h5></a>
                          
                            </div>

                            <div class="foot-block col-md-3 col-sm-12 col-xs-12">
                                <a href="{{url('privacy')}}" class="foot-item">   <h5 class="foot-tit">Privacy Policy</h5></a>
                               
                                
                            </div>

                            <div class="foot-block col-md-3 col-sm-12 col-xs-12">
                                <a href="{{url('terms')}}" class="foot-item"><h5 class="foot-tit">Terms Of use</h5></a>
                              
                            </div>
                            <div class="foot-block col-md-3 col-sm-12 col-xs-12">
                                <a href="{{url('cancellation')}}" class="foot-item">
                                           <h5 class="foot-tit">Cancelation Policy</h5>
                                </a>
